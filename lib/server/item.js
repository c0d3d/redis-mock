 ...
 */
const RedisItem = function (type, expire) {
 ...
 */
const RedisString = function (value, expires) {
 ...
 */
const RedisBuffer = function (value, expires) {
 ...
 */
var RedisStream = function () {
  RedisItem.call(this, 'stream');
  this.value = [];
};
util.inherits(RedisStream, RedisItem);
...
RedisItemFactory.createStream = function() {
